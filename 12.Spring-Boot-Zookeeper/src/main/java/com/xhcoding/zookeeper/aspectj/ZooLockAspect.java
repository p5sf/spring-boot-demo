package com.xhcoding.zookeeper.aspectj;

import cn.hutool.core.util.ArrayUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import com.xhcoding.zookeeper.annotation.LockKeyParam;
import com.xhcoding.zookeeper.annotation.ZooLock;
...
public class ZooLockAspect {
     ...
     * 切入点
     */
    @Pointcut("@annotation(com.xhcoding.zookeeper.annotation.ZooLock)")
    public void doLock() {
