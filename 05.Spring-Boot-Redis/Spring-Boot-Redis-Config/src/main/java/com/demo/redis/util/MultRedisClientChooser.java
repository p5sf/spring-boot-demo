...
public class MultRedisClientChooser {
    ...
    public static class ProtostuffParser<T> implements DataParser {
        ...
        @Override
        public byte[] enc(Object obj) {
            return com.demo.redis.util.ProtoStuffUtil.serialize(obj);
        }

        @Override
        public byte[] encList(List obj) {
            return com.demo.redis.util.ProtoStuffUtil.serializeList(obj);
        }

        @Override
        public T dec(byte[] bytes) {
            return com.demo.redis.util.ProtoStuffUtil.deserialize(bytes, type);
        }

        @Override
        public List<T> decList(byte[] bytes) {
            return com.demo.redis.util.ProtoStuffUtil.deserializeList(bytes, type);
        }
    }
